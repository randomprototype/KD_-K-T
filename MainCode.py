...
def main():
    ...
    if choice == menu[0]:
        ...
        st.write("Insert cost of failure")
        st.latex("C_{F}")
        ...
        st.write("Insert cost of defective by time unit")
        st.latex("C_{D}")
