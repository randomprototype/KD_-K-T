...
def main():
    ...
    if choice == menu[0]:
        ...
        Ci=st.number_input(r"Insert cost of inspection ($C_I$)", min_value = 0.0, value = 0.05, help="This parameter represents the cost associated with conducing an inspection.")
