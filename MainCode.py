...
def main():
    ...
    if choice == menu[0]:
        ...
        cd=st.number_input("Insert cost of defective by time unit (C_F)", min_value = 0.0, value = 0.01, help="This parameter represents the unitary cost associated with the time in which the component stays in defective state for each time unit.")
